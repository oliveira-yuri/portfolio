...
describe('página de tag', () => {
  ...
  it('não pula nível de título entre o <h1> da tag e o <h3> de cada mês do ArchiveList (WCAG 1.3.1)', async () => {
    render(await TagPage({ params: Promise.resolve({ locale: 'pt', tag: 'estatistica' }) }))
    ...
    // entre o h1 e o(s) h3 de mês, não é só ausência de headings.
